...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="jeecgCodeController.do?doUpdate" tiptype="1">
  ...
  <script src = "webpage/com/buss/nnnn/jeecgCode.js"></script>		